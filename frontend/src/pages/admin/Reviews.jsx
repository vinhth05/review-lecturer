              ...
              <CardContent className="p-0">
                <div className="flex flex-col md:flex-row">
                  <div className="p-6 md:w-3/4 flex flex-col gap-4">
                    ...
                    <p className="text-foreground whitespace-pre-wrap bg-muted/30 p-4 rounded-md border text-sm">
                      {review.comment}
                    </p>
                  ...
                  <div className="bg-muted/50 p-6 md:w-1/4 flex flex-row md:flex-col items-center justify-center gap-3 border-t md:border-t-0 md:border-l">
                    <Button 
